...
function (_React$Component) {
  ...
  function Scrollbar() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "update", function () {
      ...
      if (!forced && (_this.scrollValues || false)) {
        if (_this.scrollValues.scrollTop === _this.content.scrollTop && _this.scrollValues.scrollLeft === _this.content.scrollLeft && _this.scrollValues.scrollHeight === _this.content.scrollHeight && _this.scrollValues.scrollWidth === _this.content.scrollWidth && _this.scrollValues.clientHeight === _this.content.clientHeight && _this.scrollValues.clientWidth === _this.content.clientWidth) {
          return _assertThisInitialized(_assertThisInitialized(_this));
        }
      }
      ...
      (_this.scrollValues || false) && _this.props.onScroll && _this.props.onScroll(currentScrollValues, _assertThisInitialized(_assertThisInitialized(_this)));
      _this.scrollValues = currentScrollValues;
      return _assertThisInitialized(_assertThisInitialized(_this));
    });
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "nativeOnScrollHandler", function () {
      ...
      (_this.scrollValues || false) && _this.props.onScroll && _this.props.onScroll.call(_assertThisInitialized(_assertThisInitialized(_this)), currentScrollValues);
      _this.scrollValues = currentScrollValues;
  ...
  _createClass(Scrollbar, [{
    ...
    value: function render() {
      ...
      var holderClassNames = "ScrollbarsCustom-holder" + (className ? " " + className : ""),
          ...
          thumbVerticalClassNames = "ScrollbarsCustom-thumb ScrollbarsCustom-thumbVertical" + (thumbVerticalClassName ? " " + thumbVerticalClassName : ""),
      ...
      return _react.default.createElement(this.props.tagName, null);
      return _react.default.createElement(tagName, _objectSpread({}, props, {
