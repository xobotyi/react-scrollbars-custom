        ...
        return (
            <div className="block" id="SandboxBlock">
                ...
                <div className="description">
                    ...
                    <div className="button" key="noScrollY" onClick={this.toggleNoScrollY}>
                        {noScrollY || noScroll ? "Enable scroll Y" : "Disable scroll Y"}
                    </div>
                    <div className="button" key="noScrollX" onClick={this.toggleNoScrollX}>
                        {noScrollX || noScroll ? "Enable scroll X" : "Disable scroll X"}
                    </div>
                    <br />
                    <div className="button" key="permanentTracks" onClick={this.togglePermanentTracks}>
                        {permanentTracks ? "Show tracks if needed" : "Always show tracks"}
                    </div>
                    <div className="button" key="permanentTracksY" onClick={this.togglePermanentTrackY}>
                        {permanentTrackY || permanentTracks ? "Show track Y if needed" : "Always show track Y"}
                    </div>
                    <div className="button" key="permanentTracksX" onClick={this.togglePermanentTrackX}>
                    ...
                    <div className="button" key="scrollBottom" onClick={this.handleScrollBottomClick}>
                        Scroll bottom
                    </div>
                    <div className="button" key="scrollLeft" onClick={this.handleScrollLeftClick}>
                        Scroll left
                    </div>
                    <div className="button" key="scrollRight" onClick={this.handleScrollRightClick}>
                        Scroll right
                    </div>
                    <br />
                    <div className="button" key="addParagraph" onClick={this.handleAddParagraphClick}>
                        Add paragraph
                    </div>
                    {!!this.state.paragraphsCount && (
                        <div className="button" key="removeParagraph" onClick={this.handleRemoveParagraphClick}>
                            Remove paragraph
                        </div>
                    )}
                </div>
