        ...
        return (
            <div className="block" id="AutohideTracksBlock">
                ...
                <div className="description">
                    Here we can see mobile-like behaviour, when scrollbars are
                    hidden when scroll is not performed.
                    <br />
                    It is implemented with help of <code>
                        onScrollStart
                    </code>{" "}
                    and <code>onScrollStop</code> callbacks.
                </div>
