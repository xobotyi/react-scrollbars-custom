...
export default class Scrollbar extends React.Component {
    ...
    addListeners = () => {
        ...
        if (noScroll) {
            ...
            content.addEventListener("scroll", this.handleScrollEvent, {
                passive: true,
            });
        }
    ...
    computeScrollTopForThumbOffset = (offset) => {
        ...
        return (
            (offset /
                (trackVerticalInnerHeight - this.thumbVertical.clientHeight)) *
        ...
        return (
            (offset /
                (trackHorizontalInnerWidth -
                    this.thumbHorizontal.clientWidth)) *
    ...
    update = (forced = false, rtlAutodetect = false) => {
        ...
        if (!forced && (this.previousScrollValues || false)) {
            if (
                this.previousScrollValues.scrollTop ===
                    this.content.scrollTop &&
                this.previousScrollValues.scrollLeft ===
                    this.content.scrollLeft &&
                this.previousScrollValues.scrollHeight ===
                    this.content.scrollHeight &&
                this.previousScrollValues.scrollWidth ===
                    this.content.scrollWidth &&
                this.previousScrollValues.clientHeight ===
                    this.content.clientHeight &&
                this.previousScrollValues.clientWidth ===
        ...
        if (forced) {
            ...
            if (verticalScrollNotBlocked) {
                ...
                this.content.style.paddingLeft = this.isRtl
                    ? (browserScrollbarWidth ? null : fallbackScrollbarWidth) +
                      "px"
                    : null;
        ...
        if (horizontalScrollPossible) {
            const trackHorizontalInnerWidth = getInnerWidth(
    ...
    render() {
        ...
        if (noScroll || (noScrollX && noScrollY)) {
            ...
            trackVerticalStyles.display = trackHorizontalStyles.display =
                "none";
        } else if (noScrollY) {
