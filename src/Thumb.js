...
export default class Thumb extends React.Component
{
    ...
    handleDragStart = (e) => {
        ...
        this.props.onDragStart && (
                ...
                ? this.props.onDragStart({axis: this.props.type, offset: e.clientX - parentRect.left - this.dragStartOffsetX})
                : this.props.onDragStart({axis: this.props.type, offset: e.clientY - parentRect.top - this.dragStartOffsetY})
        );
    };

    handleDragEvent = (e) => {
        if (e.which !== 1 || !this.props.onDrag) {return;}
        ...
        this.props.type === TYPE_X
        ? this.props.onDrag({axis: this.props.type, offset: e.clientX - parentRect.left - this.dragStartOffsetX})
        : this.props.onDrag({axis: this.props.type, offset: e.clientY - parentRect.top - this.dragStartOffsetY});
    };
    ...
    render() {
        const {
                  className, renderer, type, elementRef, onDrag, onDragStart, onDragEnd,
                  ...props
              } = this.props;
