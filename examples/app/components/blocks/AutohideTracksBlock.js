        ...
        return (
                <div className="block" id="AutohideTracksBlock">
                    ...
                    <div className="description">
                        Here we can see mobile-like behaviour, when scrollbars are hidden when scroll is not performed.<br />
                    ...
                    <div className="content" style={ {height: 280} } >
                        <Scrollbar trackVerticalStyle={ {opacity: 0} } ref={ (ref) => {this.scrollbar = ref;} }
                                   onScrollStart={ this.handleScrollStart } onScrollStop={ this.handleScrollStop } scrollDetectionThreshold={ 500 }>
