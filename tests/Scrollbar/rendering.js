            ...
            it("thumbs should be proper size", done => {
                render(
                    ...
                    function() {
                        setTimeout(() => {
                            // 92 / 200 * 92 = 42.32
                            expect(this.thumbVertical.style.height).toBe(
                                "42px",
                            );
                            expect(this.thumbHorizontal.style.width).toBe(
                                "42px",
                            );
        ...
        describe("when using custom classname", () => {
            it("should apply if it is string", done => {
                render(
                    ...
                    function() {
                        expect(
                            this.holder.classList.contains(
                                "myAwesomeClassName",
                            ),
                        ).toBeTruthy();
                        expect(
                        ...
                        expect(
                            this.trackHorizontal.classList.contains(
                                "myAwesomeClassName",
                            ),
                        ).toBeTruthy();
                        expect(
                            this.trackVertical.classList.contains(
                                "myAwesomeClassName",
                            ),
                        ).toBeTruthy();
                        expect(
                            this.thumbHorizontal.classList.contains(
                                "myAwesomeClassName",
                            ),
                        ).toBeTruthy();
                        expect(
                            this.thumbVertical.classList.contains(
                                "myAwesomeClassName",
                            ),
                        ).toBeTruthy();
            ...
            it("should use it", done => {
                render(
                    ...
                    function() {
                        ...
                        expect(this.trackHorizontal.style.maxWidth).toBe(
                            "100%",
                        );
                        expect(this.trackVertical.style.maxWidth).toBe("100%");
                        expect(this.thumbHorizontal.style.maxWidth).toBe(
                            "100%",
                        );
        ...
        describe("when content does not overflow wrapper", () => {
            ...
            it("except situation when `permanentScrollbars={true}`", done => {
                render(
                    ...
                    function() {
                        setTimeout(() => {
                            expect(this.trackVertical.style.display).not.toBe(
                                "none",
                            );
                            expect(this.trackHorizontal.style.display).not.toBe(
                                "none",
                            );
            ...
            it("left part of content should be hidden", done => {
                render(
                    ...
                    function() {
                        setTimeout(() => {
                            expect(this.content.style.marginRight).toBe("");
                            expect(this.content.style.marginLeft).toBe(
                                -getScrollbarWidth() + "px",
                            );
            ...
            it("should override direction value", done => {
                ...
                render(
                    ...
                    function() {
                        setTimeout(() => {
                            expect(
                                scrollbar.holder.classList.contains(
                                    "ScrollbarsCustom-RTL",
                                ),
                            ).toBeFalsy();
                ...
                render(
                    ...
                    function() {
                        setTimeout(() => {
                            ...
                            expect(this.thumbVertical.style.display).not.toBe(
                                "none",
                            );
                            done();
                        }, 100);
                ...
                render(
                    ...
                    function() {
                        setTimeout(() => {
                            ...
                            expect(this.content.style.overflowX).not.toBe(
                                "hidden",
                            );
            ...
            it("if `scrollY={ true }` and `permanentScrollbarY={true}` are passed", done => {
                render(
                    ...
                    function() {
                        setTimeout(() => {
                            expect(this.trackVertical.style.display).toBe("");
                            expect(this.thumbVertical.style.display).toBe(
                                "none",
                            );
                            expect(this.content.style.overflowY).toBe("hidden");
                            expect(this.content.style.marginRight).toBe("");
                ...
                render(
                    ...
                    function() {
                        setTimeout(() => {
                            ...
                            expect(this.content.style.overflowY).not.toBe(
                                "hidden",
                            );
            ...
            it("if `noScrollX={ true }` and `permanentScrollbarX={true}` are passed", done => {
                render(
                    ...
                    function() {
                        setTimeout(() => {
                            expect(this.trackHorizontal.style.display).toBe("");
                            expect(this.thumbHorizontal.style.display).toBe(
                                "none",
                            );
                            expect(this.content.style.overflowX).toBe("hidden");
                            expect(this.content.style.marginBottom).toBe("");
        ...
        describe("update should be performed", () => {
            it("if props has changed", done => {
                ...
                render(<TestComponent />, node, function() {
                    ...
                    setTimeout(() => {
                        expect(
                            this.scrollbar.trackHorizontal.style.display,
                        ).toBe("none");
                        expect(this.scrollbar.trackVertical.style.display).toBe(
                            "none",
                        );
                        expect(this.scrollbar.content.style.overflowX).toBe(
                            "hidden",
                        );
                        expect(this.scrollbar.content.style.overflowY).toBe(
                            "hidden",
                        );
                        expect(this.scrollbar.content.style.overflow).toBe(
                            "hidden",
                        );
