    ...
    describe("rendering", () => {
        ...
        describe("when content does not overflow wrapper", () => {
            ...
            it("except situation when `permanentScrollbars={true}`", done => {
                render(
                    <Scrollbar style={{width: 100, height: 100}} permanentScrollbars={true}>
                        <div style={{width: 50, height: 50}} />
                    </Scrollbar>,
                    node,
                    function() {
            ...
            it("or `permanentScrollbarY={true}`", done => {
                render(
                    <Scrollbar style={{width: 100, height: 100}} permanentScrollbarY={true}>
                        <div style={{width: 50, height: 50}} />
                    </Scrollbar>,
                    node,
                    function() {
            ...
            it("or `permanentScrollbarX={true}`", done => {
                render(
                    <Scrollbar style={{width: 100, height: 100}} permanentScrollbarX={true}>
                        <div style={{width: 50, height: 50}} />
                    </Scrollbar>,
                    node,
                    function() {
        ...
        describe("vertical track should be displayed without thumb", () => {
            it("if `scrollY={ true }` and `permanentScrollbarY={true}` are passed", done => {
                render(
                    <Scrollbar style={{width: 100, height: 100}} noScrollY={true} permanentScrollbarY={true}>
                        <div style={{width: 200, height: 200}} />
                    </Scrollbar>,
                    node,
                    function() {
        ...
        describe("horizontal track should be displayed without thumb", () => {
            it("if `noScrollX={ true }` and `permanentScrollbarX={true}` are passed", done => {
                render(
                    <Scrollbar style={{width: 100, height: 100}} noScrollX={true} permanentScrollbarX={true}>
                        <div style={{width: 200, height: 200}} />
                    </Scrollbar>,
                    node,
                    function() {
        ...
        describe("both tracks should be displayed without thumb", () => {
            it("if `noScroll` and `permanentScrollbars={true}`", done => {
                render(
                    <Scrollbar style={{width: 100, height: 100}} noScroll permanentScrollbars>
                        <div style={{width: 200, height: 200}} />
                    </Scrollbar>,
                    node,
                    function() {
