  ...
  describe("rendering", () => {
    ...
    describe("when <Scrollbar /> rendered", () => {
      ...
      it("thumbs size should not be less than 'minimalThumbsSize'", done => {
        render(
          <Scrollbar style={{ width: 100, height: 100 }} minimalThumbsSize={50}>
    ...
    describe("when using custom classname", () => {
      it("should apply if it is string", done => {
        render(
          <Scrollbar
            ...
            wrapperClassName="myAwesomeClassName"
            contentClassName="myAwesomeClassName"
            trackHorizontalClassName="myAwesomeClassName"
            trackVerticalClassName="myAwesomeClassName"
            thumbHorizontalClassName="myAwesomeClassName"
            thumbVerticalClassName="myAwesomeClassName"
          />,
          node,
          function() {
            expect(
              this.holder.classList.contains("myAwesomeClassName")
            ).toBeTruthy();
            expect(
              this.wrapper.classList.contains("myAwesomeClassName")
            ).toBeTruthy();
            expect(
              this.content.classList.contains("myAwesomeClassName")
            ).toBeTruthy();
            expect(
              this.trackHorizontal.classList.contains("myAwesomeClassName")
            ).toBeTruthy();
            expect(
              this.trackVertical.classList.contains("myAwesomeClassName")
            ).toBeTruthy();
            expect(
              this.thumbHorizontal.classList.contains("myAwesomeClassName")
            ).toBeTruthy();
            expect(
              this.thumbVertical.classList.contains("myAwesomeClassName")
            ).toBeTruthy();
      ...
      it("should apply if it is an array", done => {
        render(
          <Scrollbar
            className={["awesome", "classname"]}
            wrapperClassName={["awesome", "classname"]}
            contentClassName={["awesome", "classname"]}
            trackHorizontalClassName={["awesome", "classname"]}
            trackVerticalClassName={["awesome", "classname"]}
            thumbHorizontalClassName={["awesome", "classname"]}
            thumbVerticalClassName={["awesome", "classname"]}
          />,
          node,
          function() {
            ...
            expect(
              this.trackHorizontal.classList.contains("awesome")
            ).toBeTruthy();
            expect(
              this.trackHorizontal.classList.contains("classname")
            ).toBeTruthy();
            expect(
              this.trackVertical.classList.contains("awesome")
            ).toBeTruthy();
            expect(
              this.trackVertical.classList.contains("classname")
            ).toBeTruthy();
            expect(
              this.thumbHorizontal.classList.contains("awesome")
            ).toBeTruthy();
            expect(
              this.thumbHorizontal.classList.contains("classname")
            ).toBeTruthy();
            expect(
              this.thumbVertical.classList.contains("awesome")
            ).toBeTruthy();
            expect(
              this.thumbVertical.classList.contains("classname")
            ).toBeTruthy();
    ...
    describe("when disabling default styles", () => {
      ...
      it("tracks should has no styles", done => {
        render(<Scrollbar defaultStyles={false} />, node, function() {
          ...
          expect(this.trackHorizontal.getAttribute("style")).toBe(
            "display: none;"
          );
          done();
        });
      ...
      it("should use it", done => {
        render(
          <Scrollbar
            ...
            trackVerticalStyle={{ maxWidth: "100%" }}
            trackHorizontalStyle={{ maxWidth: "100%" }}
            thumbVerticalStyle={{ maxWidth: "100%" }}
            thumbHorizontalStyle={{ maxWidth: "100%" }}
          />,
          node,
          function() {
    ...
    describe("only vertical scroll should be blocked", () => {
      it("if noScrollY={ true } is passed", done => {
        render(
          <Scrollbar style={{ width: 100, height: 100 }} noScrollY={true}>
            <div style={{ width: 200, height: 200 }} />
          </Scrollbar>,
          node,
          function() {
    ...
    describe("update should be performed", () => {
      it("if props has changed", done => {
        ...
        render(<TestComponent />, node, function() {
