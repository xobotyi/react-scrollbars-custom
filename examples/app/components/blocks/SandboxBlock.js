...
export default class SandboxBlock extends React.Component {
  constructor(props) {
    ...
    this.toggleNativeScrollbarClick = this.toggleNativeScrollbarClick.bind(
      this
    );
  ...
  togglePermanentTrackY() {
    this.setState({
      permanentTracks:
        (this.state.permanentTracks ? true : this.state.permanentTrackX) &&
  ...
  togglePermanentTrackX() {
    this.setState({
      permanentTracks:
        !this.state.permanentTrackX &&
        (this.state.permanentTracks ? true : this.state.permanentTrackY),
      ...
      <div className="block" id="SandboxBlock">
        ...
        <div className="description">
          <div
            className="button"
            key="nativeScrollbar"
            onClick={this.toggleNativeScrollbarClick}
          >
