...
export default class SandboxBlock extends React.Component
{
    ...
    togglePermanentTrackY() {
        this.setState({
                          ...this.state,
                          permanentTracks: (this.state.permanentTracks ? true : this.state.permanentTrackX) && !this.state.permanentTrackY,
    ...
    togglePermanentTrackX() {
        this.setState({
                          ...this.state,
                          permanentTracks: !this.state.permanentTrackX && (this.state.permanentTracks ? true : this.state.permanentTrackY),
        ...
        return (
                <div className="block" id="SandboxBlock">
                    ...
                    <div className="description">
                        <div className="button" key="noScroll" onClick={ this.toggleNoScroll }>{ noScroll ? "Enable scroll" : "Disable scroll" }</div>
                        <div className="button" key="noScrollY" onClick={ this.toggleNoScrollY }>{ noScrollY || noScroll ? "Enable scroll Y" : "Disable scroll Y" }</div>
                        <div className="button" key="noScrollX" onClick={ this.toggleNoScrollX }>{ noScrollX || noScroll ? "Enable scroll X" : "Disable scroll X" }</div>
                        <br />
                        ...
                        <div className="button" key="scrollBottom" onClick={ this.handleScrollBottomClick }>Scroll bottom</div>
                        <div className="button" key="scrollLeft" onClick={ this.handleScrollLeftClick }>Scroll left</div>
